...
def test_spectral_mixture():
    ...
    model = SpectralMixtureGPModel(train_x, train_y, num_mixtures=6, likelihood=likelihood)
    
    trainer = SpectralMixtureTrainer(model, likelihood, lr=0.01)
    ...
    with torch.no_grad(), gpytorch.settings.fast_pred_var():
        ...
        ax.legend(loc='best', fontsize=16, facecolor='white', framealpha=0.5)
